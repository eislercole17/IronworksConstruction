    ...
    <main className="flex w-full h-full">
      <div className="w-full min-h-screen bg-white">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-4 px-4 w-full place-items-center mt-2 ">
          {/* Card 1 */}
          <div class="max-lg:max-w-sm w-full p-6 h-full  border border-gray-200 rounded-lg shadow bg-zinc-200 mt-4 hover:-translate-y-1 hover:scale-110 transition ease-in-out delay-150 max-sm">
            <a href="#">
            ...
            <div>
              <p class="mb-3 font-normal text-gray-700 dark:text-gray-500 lg:text-xl">
          ...
          {/* card two */}
          <div class="max-lg:max-w-sm w-full p-6 h-full border border-gray-200 rounded-lg shadow bg-zinc-200 mt-4 hover:-translate-y-1 hover:scale-110 transition ease-in-out delay-150 ">
            <a href="#">
              <h5 class="mb-2 text-2xl font-bold tracking-tight text-gray-900 dark:text-Black sm:text-3xl">
                Truck/Trailer:
              </h5>
